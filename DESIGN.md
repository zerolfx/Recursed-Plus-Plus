...
- Preserved instances and cauldron semantics, including entering a jar whose room was never stored, which builds `glitch`, and a paradox a cauldron or jar causes when the room it returns to has lost it.
